    ...
    implements ControlValueAccessor, OnInit, OnDestroy
{
    ...
    private readonly _timeRegExp: RegExp = new RegExp(
        '^(0[0-9]|1[0-9]|2[0-4]|[0-9]):([0-5][0-9])(A|(?:AM)|P|(?:PM))?$',
        'i'
    );
    ...
    set range(value) {
        ...
        if (whichDate === 'start') {
            ...
            if (this._range.start.isAfter(this._range.end)) {
                ...
                const endDate = start
                    .clone()
                    .hours(this._range.end.hours())
                    .minutes(this._range.end.minutes())
                    .seconds(this._range.end.seconds());
        ...
        if (whichDate === 'end') {
            ...
            if (this._range.start.isAfter(this._range.end)) {
                ...
                const startDate = end
                    .clone()
                    .hours(this._range.start.hours())
                    .minutes(this._range.start.minutes())
                    .seconds(this._range.start.seconds());
